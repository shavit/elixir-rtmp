defmodule ExRTMP.AMF.AMF0Test do
  ...
  describe "amf0 encode" do
    ...
    test "encode/1 object message" do
      ...
      assert AMF0.encode(msg) == <<3, 0, 4, 67, 105, 116, 121, 2, 0, 9, 115, 111, 109, 101, 32, 99, 105, 116,
   121, 0, 4, 78, 97, 109, 101, 2, 0, 9, 115, 111, 109, 101, 32, 110, 97, 109,
   101, 0, 0, 9>>
    end
  ...
  describe "amf0 decode" do
    ...
    test "decode/1 strict array" do
      ...
      msg = <<10, 0, 0, 0, 3, 0, 64, 8, 0, 0, 0, 0, 0, 0, 0, 64, 16, 0, 0, 0, 0, 0, 0, 0,
  64, 20, 0, 0, 0, 0, 0, 0>>
